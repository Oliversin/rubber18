...
export default class AboutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Standard Meta Tags
    this.addMetaTag('description', 'Know about us: Rotomold Mexico, a family-owned leader in advanced manufacturing, operates a vertically integrated facility in Ensenada, Mexico.');
    ...
    this.addMetaTag('og:description', 'Know about us: Rotomold Mexico, a family-owned leader in advanced manufacturing, operates a vertically integrated facility in Ensenada, Mexico.', 'property');
    ...
    this.addMetaTag('twitter:description', 'Know about us: Rotomold Mexico, a family-owned leader in advanced manufacturing, operates a vertically integrated facility in Ensenada, Mexico.');
